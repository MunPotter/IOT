...
//      object.set("sensor", sensor);
//      object.set("battery", battery);
//      object.set("date_time", t);
//      object.set("fuel", cut);
//      object.set("power_source", power);
      ...
      gsmSerial.println("AT+HTTPPARA=\"URL\",\"http://api.rokkhi.com:8000/iott\""); //Server address
      delay(200);
      ShowSerialData();
