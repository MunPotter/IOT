...
<html>
    ...
    <body>
        ...
        <section class="main">
            <div id="logo">
                <label for="nav-toggle-cb" id="nav-toggle">&#9776;&nbsp;&nbsp;ROKKHI Camera Settings</label>
            </div>
            <div id="content">
                <div id="sidebar">
                    ...
                    <nav id="menu">
                        <section id="buttons">
                            <button id="get-still">Get Capture</button>
                        ...
                        <section id="buttons">
                            <button id="face_enroll" class="disabled" disabled="disabled">Train Face</button>
                        </section> 
                            ...
                            <div>
                            <input type="text" id="facename" size="8" style="height:14px">
                            <button style="text-align: center" onclick="var ifr = document.getElementById('ifr');var ifrlab = document.getElementById('ifrlab');ifr.style.display='block';ifrlab.style.display='block';ifr.src=document.location.origin+'/control?facename='+document.getElementById('faceid').value+';'+document.getElementById('facename').value;">Set</button>
                       </div>
                       </div>
